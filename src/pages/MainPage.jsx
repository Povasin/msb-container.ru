  ...
  return (
    <main>
        <div className="fd-row">
            <div className="slider">
                ...
                <div className="navigation">
                    <label for="r1" className="navigation__bar"></label>
                    <label for="r2" className="navigation__bar"></label>
                    <label for="r3" className="navigation__bar"></label>
                    <label for="r4" className="navigation__bar"></label>
                </div>
            </div>
        ...
        <div className="katalog">
            ...
            <a href="./katalog/katalog.html" className="more">посмотреть все бытовки</a>
        </div>
        <div className="line"></div>
    </main>
  )
